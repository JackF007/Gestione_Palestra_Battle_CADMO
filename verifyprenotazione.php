...
if (isset($_POST['mod-prenotazione'])) { //vengo da controllo
    ...
    $url2 = "Location: profile.php?day=$str_data&modificato=1";
    $url3 = "Location: prenotazioni.php?day=$str_data&modificato=0";
    $url4 = "Location: profile.php?day=$str_data&modificato=0";
...
if (isset($_POST['invia-prenotazione'])) { //vengo da controllo
    ...
    $url2 = "Location: profile.php?day=$str_data&prenotato=1";
    $url3 = "Location: prenotazioni.php?day=$str_data&prenotato=0";
    $url4 = "Location: profile.php?day=$str_data&prenotato=0";
