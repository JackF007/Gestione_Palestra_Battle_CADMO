                                        ...
                                        if (!(isset($_POST['ricerca'])) && (isset($_GET['day']) && is_numeric($_GET['day']))) { // passaggio valori automatici
                                            ...
                                            while ($row = mysqli_fetch_array($result, MYSQLI_NUM)) {
                                                ...
                                                if ($row[0] < 8) {
                                                    ...
                                                    echo "<div class=\"input-group date\" id=\"reservationdate\" data-target-input=\"nearest\">
                                            <input type=\"date\" class=\"form-control datetimepicker-input\" id=\"timedata\" name=\"time-data\" value=\"$y-$m-$d\"></div>";
                                                    echo "<button name=\"invia-prenotazione\" type=\"submit\" class=\"btn btn-primary w-100\">Registra Prenotazione</button>"; //appare form e messaggio ok validita;
                                                } else { //reindirizza con messaggio a se stesso }
                                                }
                                            }
                                        }else{
                                            echo "<div class=\"input-group date\" id=\"reservationdate\" data-target-input=\"nearest\">
                                             <input type=\"date\" class=\"form-control datetimepicker-input\" id=\"timedata\" name=\"time-data\" value=\"0000-00-00\" required></div>";
                                            echo "<button name=\"invia-prenotazione\" type=\"submit\" class=\"btn btn-primary w-100\">Registra Prenotazione</button>";
                                        }
 ?>
                                    </form>
                                </div>
